...
public extension UITextField {
	...
	func setRightViewFAIcon(icon: FAType, rightViewMode: UITextField.ViewMode = .always, orientation: UIImage.Orientation = .down, textColor: UIColor = .black, backgroundColor: UIColor = .clear, size: CGSize? = nil) {
	...
	func setLeftViewFAIcon(icon: FAType, leftViewMode: UITextField.ViewMode = .always, orientation: UIImage.Orientation = .down, textColor: UIColor = .black, backgroundColor: UIColor = .clear, size: CGSize? = nil) {
        FontLoader.loadFontIfNeeded()
